...
Filters = {'JPLUS' : ['uJAVA', 'J0378', 'J0395', 'J0410', 'J0430', 'gSDSS', 'J0515',
           ...
           'SPLUS' : ['u', 'J0378', 'J0395', 'J0410', 'J0430', 'g', 'J0515',
                      'r','J0660','i','J0861', 'z'],
...
def AdjacentSubplots(X,Y,minX,maxX,label='label',title='title',xlabel='X_Label',ylabel='Y_Label',loc=4, frameon=True, handlelength=2, markerscale=1, ticks_size=30, grid=True):
    ...
    axs[0].set_ylabel(ylabel,fontsize=32)
    axs[0].set_title(title,fontsize=32)
    axs[0].legend(fontsize=32,loc=loc, frameon=frameon, handlelength=handlelength, markerscale=markerscale)
    axs[0].tick_params('y',labelsize=ticks_size)
